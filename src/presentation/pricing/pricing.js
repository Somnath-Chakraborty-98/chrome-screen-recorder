...
const FEATURE_LABELS = {
  ...
  max_quality: (v) => `${capitalize(v)} export quality`,
  mp4_enabled: (v) => (v ? 'MP4 export' : 'WebM only'),
  watermark_enabled: (v) => (v ? 'Watermark on exports' : 'No watermark'),
...
function buildFeatureList(plan) {
  return [
    ...
    FEATURE_LABELS.mp4_enabled(plan.mp4_enabled),
    FEATURE_LABELS.watermark_enabled(plan.watermark_enabled),
